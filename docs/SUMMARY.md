...
* [Global configuration options](docs/reference/forge-config.md)
  * [Self Signed Registries](docs/reference/self-signed-registries.md)
* [Service descriptor](docs/reference/service-yaml.md)
...
* [Ask on Gitter](https://gitter.im/datawire/forge)
* [File a GitHub Issue](https://github.com/datawire/forge/issues/new)
